...
```
cd existing_repo
git remote add origin https://gitlabinfo.iutmontp.univ-montp2.fr/groupe-php/projet-php.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlabinfo.iutmontp.univ-montp2.fr/groupe-php/projet-php/-/settings/integrations)
